...
public class NMS_v1_10_R1 implements NMS {
    ...
    Material beetroot = Material.getMaterial("BEETROOT_BLOCK");
    ...
    public void setBiteTime(FishHook hook, int time){
        net.minecraft.server.v1_10_R1.EntityFishingHook hookCopy = (EntityFishingHook) ((CraftEntity) hook).getHandle();

        if(fishCatchTime==null) {
            try {
                fishCatchTime = net.minecraft.server.v1_10_R1.EntityFishingHook.class.getDeclaredField("av");
