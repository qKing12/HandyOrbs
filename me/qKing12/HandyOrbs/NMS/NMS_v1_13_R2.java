...
public class NMS_v1_13_R2 implements NMS {
    ...
    public void setBiteTime(FishHook hook, int time){
        ...
        if(fishCatchTime==null) {
            try {
                fishCatchTime = net.minecraft.server.v1_13_R2.EntityFishingHook.class.getDeclaredField("aw");
