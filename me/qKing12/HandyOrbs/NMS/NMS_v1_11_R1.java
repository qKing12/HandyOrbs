...
public class NMS_v1_11_R1 implements NMS {
    ...
    public void setBiteTime(FishHook hook, int time){
        net.minecraft.server.v1_11_R1.EntityFishingHook hookCopy = (EntityFishingHook) ((CraftEntity) hook).getHandle();

        if(fishCatchTime==null) {
            try {
                fishCatchTime = net.minecraft.server.v1_11_R1.EntityFishingHook.class.getDeclaredField("h");
