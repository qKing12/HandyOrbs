...
public class NMS_v1_9_R2 implements NMS {
    ...
    public void setBiteTime(FishHook hook, int time){
        net.minecraft.server.v1_9_R2.EntityFishingHook hookCopy = (EntityFishingHook) ((CraftEntity) hook).getHandle();

        if(fishCatchTime==null) {
            try {
                fishCatchTime = net.minecraft.server.v1_9_R2.EntityFishingHook.class.getDeclaredField("aw");
