...
public class PlayerData {
    ...
    public static int totalOrbs(String p){
        return getTotalFarmingCarrotsOrbs(p)+getTotalFarmingPotatoesOrbs(p)+getTotalFarmingWheatOrbs(p)+getTotalFishingOrbs(p)+getTotalNetherWartOrbs(p)+getTotalSugarCaneOrbs(p)+getTotalFlowerOrbs(p)+getTotalRainbowOrbs(p);
    }
