    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        if (sender instanceof Player) {
            ...
            if(args.length>=1) {
                                ...
                                if(args.length>=3){
                                    switch(args[2]){
                                        ...
                                        default:
                                            ...
                                            p.sendMessage(utils.chat("&fList of orb types: wheat, carrots, potatoes, nether-wart, sugar-cane, fishing, flower, rainbow, radiant, saving-grace, tree-spawner"));
                                            return true;
                                    }
                                }
                                else
                ...
                if (cmd.getName().equalsIgnoreCase("handyorbs")) {
                    p.openInventory(ConfigLoad.adminInventory);
                }
            }
        }
                        ...
                        if (args.length >= 3) {
                            switch (args[2]) {
                                ...
                                default:
                                    ...
                                    sender.sendMessage(utils.chat("&fList of orb types: wheat, carrots, potatoes, nether-wart, sugar-cane, fishing, flower, rainbow, radiant, saving-grace, tree-spawner"));
                                    return true;
                            }
                        } else
